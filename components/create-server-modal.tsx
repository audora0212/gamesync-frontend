    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>새로운 게임 서버를 생성합니다.</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="name" variant="neon" className="flex items-center gap-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="resetTime" variant="neon" className="flex items-center gap-2">
