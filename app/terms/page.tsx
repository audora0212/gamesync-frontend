    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 z-10">
        <div className="mx-auto max-w-3xl px-6 py-12">
          ...
          {lang==='ko' ? (
            <>
              <h1 className="text-3xl font-semibold text-neon-magenta drop-shadow-[0_0_10px_rgba(217,4,142,0.5)] font-display">이용약관</h1>
            ...
            <>
              <h1 className="text-3xl font-semibold text-neon-magenta drop-shadow-[0_0_10px_rgba(217,4,142,0.5)] font-display">Terms of Service</h1>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-cyan">{lang==='ko' ? '1. 목적' : '1. Purpose'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-magenta">{lang==='ko' ? '2. 용어의 정의' : '2. Definitions'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-green">{lang==='ko' ? '3. 약관의 게시와 개정' : '3. Posting and Amendments'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-pink">{lang==='ko' ? '4. 서비스의 제공' : '4. Provision of the Service'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-yellow">{lang==='ko' ? '5. 이용자의 의무' : '5. User Obligations'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-cyan">{lang==='ko' ? '6. 권리의 귀속' : '6. Ownership of Rights'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-magenta">{lang==='ko' ? '7. 책임 제한' : '7. Limitation of Liability'}</h2>
          ...
          <section className="mt-8 space-y-3">
            <h2 className="text-xl font-medium text-neon-green">{lang==='ko' ? '8. 분쟁의 해결' : '8. Dispute Resolution'}</h2>
