...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen grid-bg">
      ...
      {lang==='ko' ? (
        <>
          <h1 className="text-3xl font-semibold neon-text-purple">이용약관</h1>
        ...
        <>
          <h1 className="text-3xl font-semibold neon-text-purple">Terms of Service</h1>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-cyan-400">{lang==='ko' ? '1. 목적' : '1. Purpose'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-purple-400">{lang==='ko' ? '2. 용어의 정의' : '2. Definitions'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-emerald-400">{lang==='ko' ? '3. 약관의 게시와 개정' : '3. Posting and Amendments'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-pink-400">{lang==='ko' ? '4. 서비스의 제공' : '4. Provision of the Service'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-yellow-400">{lang==='ko' ? '5. 이용자의 의무' : '5. User Obligations'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-cyan-400">{lang==='ko' ? '6. 권리의 귀속' : '6. Ownership of Rights'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-purple-400">{lang==='ko' ? '7. 책임 제한' : '7. Limitation of Liability'}</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium text-emerald-400">{lang==='ko' ? '8. 분쟁의 해결' : '8. Dispute Resolution'}</h2>
