...
export default function SupportPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-semibold">{lang==='ko' ? '지원 센터' : 'Support Center'}</h1>
      ...
      <div className="rounded-lg border p-6">
        <div className="mb-4 grid gap-2">
          <Label htmlFor="subject">{lang==='ko' ? '제목' : 'Subject'}</Label>
          <Input
            id="subject"
        ...
        <div className="mb-6 grid gap-2">
          <Label htmlFor="message">{lang==='ko' ? '내용' : 'Message'}</Label>
          <textarea
            id="message"
      ...
      <div className="mt-10 grid gap-4">
        <div>
          <h2 className="text-xl font-medium">{lang==='ko' ? 'FAQ / 정책' : 'FAQ / Policies'}</h2>
          <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
            ...
            <li>
              {lang==='ko' ? '개인정보 처리방침' : 'Privacy Policy'}: <Link className="underline" href="/privacy">/privacy</Link>
            </li>
            <li>
              {lang==='ko' ? '서비스 이용약관' : 'Terms of Service'}: <Link className="underline" href="/terms">/terms</Link>
            </li>
          </ul>
        </div>
